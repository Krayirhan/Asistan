...
RTX 2060 Super için optimizasyon amaçlı
"""
...
try:
    ...
    logger.warning("pynvml yüklü değil! pip install pynvml")
...
class VRAMMonitor:
    ...
    def __init__(self, config: dict):
        ...
        if PYNVML_AVAILABLE:
            ...
            logger.warning("VRAM monitoring devre dışı")
    ...
    def _init_nvml(self):
        ...
        try:
            ...
            logger.success(f"GPU algılandı: {gpu_name}")
    ...
    def get_vram_info(self) -> Dict:
        ...
        try:
            ...
            logger.error(f"VRAM bilgisi alma hatası: {e}")
    ...
    def get_gpu_utilization(self) -> Optional[float]:
        ...
        try:
            ...
            logger.error(f"GPU utilization hatası: {e}")
            return None
    ...
    def get_temperature(self) -> Optional[float]:
        ...
        try:
            ...
            logger.error(f"Sıcaklık okuma hatası: {e}")
            return None
    ...
    def print_stats(self):
        ...
        if not stats['vram']['available']:
            logger.info("GPU monitoring mevcut değil")
            return
